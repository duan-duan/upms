 ...
 * 
 */
package com.upms.web.component;
...
public class UserOperatorLogAspect {
	...
	@Pointcut("execution(* com.common.service.*.create*(..))")
	...
	@Pointcut("execution(* com.common.service.*.update*(..))")
	...
	@Pointcut("execution(* com.common.service.*.delete*(..))")
